...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "SCORP-XD~",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "SCORP-XD",  // Bot's display name
    ...
    DEV: process.env.DEV || "22898452555",                     // Developer's contact number
    
    // ===== AUTO-RESPONSE SETTINGS =====
    
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",// Reply to status updates?
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SCORP BOT VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "SCORP-XD",     // Sticker pack name
